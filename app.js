...
(function(){
  ...
  form.addEventListener('submit', (e) => {
    ...
    if (!food) {
      resultBox.innerHTML = `<p class="fcheck__notfound">No exact match for "<strong>${input.value}</strong>" in the database yet. Try a close term (e.g. "rice", "egg", "ragi", "chicken", "prawns") — Mr. Prashanth's team keeps adding local items.</p>`;
      return;
    }
